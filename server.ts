...
app.get("/api/news/police", async (req: Request, res: Response) => {
...
app.get("/api/scrape-image", async (req: Request, res: Response) => {
...
// ----------------------------------------------------
app.post("/api/news/briefing", async (req: Request, res: Response) => {
